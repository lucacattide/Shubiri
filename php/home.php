    ...
    <div class="topbar-left pull-left">
        <div class="clearfix">
            <ul class="left-branding pull-left clickablemenu ttmenu dark-style menu-color-gradient">
                ...
                <li>
                    <div class="logo">
                        <a href="index.php" title="Shubiri Admin">
        ...
        <div class="tab-content">
            <div role="tabpanel" class="tab-pane active" id="menu">
                <ul class="list-accordion">
                    ...
                    <li>
                        <a href="#"><i class="zmdi zmdi-link"></i><span class="list-label">Elenco pagine</span></a>
                        <ul>
                            <?php
							 ...
							 ?>
                             <li>
                              <a href="index.php?pag=crea-pagina&id=<?php echo $rowListPagina["pagina_id"];  ?>"><i class="zmdi zmdi-link"></i> <?php echo $rowListPagina["pagina_url"];  ?> </a>
                             </li>
                            <?php endwhile; endif;  ?>
                        </ul>
                    </li>
